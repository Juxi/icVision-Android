...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		bindPreferenceSummaryToValue(findPreference("current_network_ip"));
		bindPreferenceSummaryToValue(findPreference("yarp_ip"));
		bindPreferenceSummaryToValue(findPreference("yarp_port"));
